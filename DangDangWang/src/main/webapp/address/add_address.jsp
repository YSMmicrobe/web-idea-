...
<body>
	...
	<div class="fill_message">
		...
		<form name="ctl00" action="${pageContext.request.contextPath}/address/insertAdrs"
			method="post" id="f" onsubmit="return checkForm()">
			<%--<input type="hidden" name="address.id" id="addressId" />--%>
			<input type="hidden" name="address.uid" id="addressUId" value="${sessionScope.user.id}"/>
			<table class="tab_login">
				<tr>
					<td valign="top" class="w1">收件人姓名：</td>
					<td><input onblur="checkname()" type="text" class="text_input"
						name="address.recvName" id="receiveName" />
				...
				<tr>
					...
					<td><input onblur="checkeaddress()" type="text"
						name="address.adrs" class="text_input" id="fullAddress" />
