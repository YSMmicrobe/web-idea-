...
<div class="head_container">
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> <span class="little_n">
					| <a href="${pageContext.request.contextPath}/address/adrsList" name="myaddress" class="head_black12a">我的收货地址</a>
					| <a href="${pageContext.request.contextPath}/order/showOrder" name="mydangdang" class="head_black12a">我的订单</a> | <a
		...
		<c:if test="${sessionScope.user != null}">
			...
			[&nbsp;<a href="${pageContext.request.contextPath}/user/userExcite" class="b">登出</a>&nbsp;]
		</span>
		</c:if>
	...
	<div class="head_head_list">
		<div class="head_head_list_left">
			<span class="head_logo"><a href="${pageContext.request.contextPath}/main" name="backtobook"><img
